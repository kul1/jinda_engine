# -*- encoding : utf-8 -*-
require_dependency "jinda_engine/application_controller"
module JindaEngine
  #class JindaController < ::ApplicationController
  class JindaController < ActionController::Base
    include JindaEngine:: Concerns:: JindaRunConcern
    include JindaEngine:: Concerns:: JindaGeneralConcern
    ...
    def init
      ...
      @service= jindra_engine::Service.where(:module_code=> module_code, :code=> code).first
